 ...
 * 
 * This activity is called when neither the product's name or product's
 * price is known. It asks the user for them and passes user's input
 * to the main activity.
 * 
 */
public class AskForInputActivity extends Activity {
